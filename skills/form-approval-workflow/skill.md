# Scope Control — ทำเฉพาะสิ่งที่ผู้ใช้สั่ง

ต้องรักษาขอบเขตของคำสั่งผู้ใช้อย่างเคร่งครัด

* แก้เฉพาะฟีเจอร์ ไฟล์ และพฤติกรรมที่เกี่ยวข้องโดยตรงกับคำสั่งล่าสุด
* ห้ามเพิ่ม เปลี่ยน ลบ หรือปรับปรุงส่วนอื่นที่ผู้ใช้ไม่ได้สั่ง แม้จะเห็นว่าสามารถทำให้ดีขึ้น สวยขึ้น หรือสะอาดขึ้นได้
* ห้าม refactor, rename, cleanup, redesign หรือเปลี่ยนโครงสร้างโค้ด ฐานข้อมูล route config authentication และ workflow ที่อยู่นอกขอบเขต
* หากงานที่สั่งจำเป็นต้องแก้ dependency ที่เกี่ยวข้อง ให้แก้เท่าที่จำเป็นขั้นต่ำเพื่อให้งานนั้นทำงานได้ และห้ามขยายผลไปยังส่วนอื่น
* หากพบ bug หรือปัญหานอกขอบเขต ให้รายงานผู้ใช้เท่านั้น ห้ามแก้เองจนกว่าผู้ใช้จะสั่ง
* ห้ามลบไฟล์ component column หรือโค้ดที่ไม่ได้อยู่ในคำสั่ง แม้ตรวจพบว่ายังไม่มีการใช้งาน
* ก่อนแก้ต้องตรวจว่าจุดที่จะเปลี่ยนมีผลกับส่วนใดบ้าง และหลังแก้ต้องตรวจ diff ว่าไม่มีการเปลี่ยนแปลงนอกขอบเขต
* การตรวจสอบงานให้ทดสอบเฉพาะสิ่งที่แก้และ regression ที่เกี่ยวข้องโดยตรง ห้ามใช้การทดสอบเป็นเหตุผลในการแก้ส่วนอื่น

หากคำสั่งใหม่ขัดกับสิ่งที่เคยทำ ให้ยึดคำสั่งล่าสุด แต่เปลี่ยนเฉพาะส่วนที่ขัดกันโดยตรง
